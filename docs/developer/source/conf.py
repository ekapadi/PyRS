...
project = u'PyRS'
copyright = u'2026, Oak Ridge National Laboratory'
...
latex_documents = [
    (master_doc, 'PyRS_dev.tex', u'PyRS Developer Documentation',
     u'PyRS developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'PyRS_dev', u'PyRS Developer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyRS_dev', u'PyRS Developer Documentation',
     author, 'PyRS_dev', 'PyRS developer documentation.',
     'Miscellaneous'),
]
